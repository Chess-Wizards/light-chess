...
class TestPositionsUnderThreat(unittest.TestCase):
    ...
    def test_positions_under_king_threat(self):
        ...
        assert sorted(PositionsUnderThreat.positions_under_king_threat(Position(4, 4), Colour.WHITE, self.board)) == \
                                                                                                      [Position(3, 3),
                                                                                                       Position(3, 5),
                                                                                                       Position(4, 5),
                                                                                                       Position(5, 3)]
    ...
    def test_positions_under_queen_threat(self):
        ...
        assert sorted(PositionsUnderThreat.positions_under_queen_threat(Position(5, 5), Colour.WHITE, self.board)) == \
                                                                                                       [Position(4, 5),
                                                                                                        Position(4, 6),
                                                                                                        Position(5, 6),
                                                                                                        Position(5, 7),
    ...
    def test_positions_under_bishop_threat(self):
        ...
        assert sorted(PositionsUnderThreat.positions_under_bishop_threat(Position(6, 6), Colour.WHITE, self.board)) == \
                                                                                                        [Position(5, 7),
                                                                                                         Position(7, 5)]
    ...
    def test_positions_under_knight_threat(self):
        ...
        assert sorted(PositionsUnderThreat.positions_under_knight_threat(Position(7, 6), Colour.WHITE, self.board)) == \
                                                                                                        [Position(5, 7),
                                                                                                         Position(6, 4)]
    ...
    def test_positions_under_rook_threat(self):
        ...
        assert sorted(PositionsUnderThreat.positions_under_rook_threat(Position(3, 7), Colour.WHITE, self.board)) == \
                                                                                                      [Position(0, 7),
                                                                                                       Position(1, 7),
                                                                                                       Position(2, 7),
                                                                                                       Position(3, 5),
    ...
    def test_positions_under_pawn_threat(self):
        ...
        assert not PositionsUnderThreat.positions_under_pawn_threat(Position(4, 3), Colour.WHITE, self.board)
        assert sorted(PositionsUnderThreat.positions_under_pawn_threat(Position(3, 4), Colour.WHITE, self.board)) == \
                                                                                                      [Position(2, 5),
                                                                                                       Position(4, 5)]
        assert sorted(PositionsUnderThreat.positions_under_pawn_threat(Position(5, 4), Colour.WHITE, self.board)) == \
                                                                                                      [Position(4, 5),
                                                                                                       Position(6, 5)]
        assert sorted(PositionsUnderThreat.positions_under_pawn_threat(Position(0, 6), Colour.WHITE, self.board)) == \
                                                                                                      [Position(1, 7)]
        assert not PositionsUnderThreat.positions_under_pawn_threat(Position(7, 7), Colour.WHITE, self.board)
        assert PositionsUnderThreat.positions_under_pawn_threat(Position(4, 5), Colour.BLACK, self.board) == \
                                                                                                      [Position(3, 4),
                                                                                                       Position(5, 4)]
    ...
    def test_all_positions_under_threat_for_side(self):
        ...
        assert sorted(PositionsUnderThreat.all_positions_under_threat_for_side(Colour.WHITE, self.board)) == \
                                                                                                      [Position(3, 4),
                                                                                                       Position(3, 7),
                                                                                                       Position(4, 7),
                                                                                                       Position(5, 4),
